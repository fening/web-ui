...
# Import directly from browser_use controller (without trying to import register_action)
...
class ScrollAction(BaseModel):
    ...
    action_type: str = "scroll"  # Include the action_type field
...
# Instead of using register_action decorator, define a scroll function directly
async def scroll(
